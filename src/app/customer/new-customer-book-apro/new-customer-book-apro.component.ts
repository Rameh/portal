...
@Component({
  selector: 'app-new-customer-book-apro',
  templateUrl: './new-customer-book-apro.component.html',
  styleUrls: ['./new-customer-book-apro.component.scss']
})
export class NewCustomerBookAproComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (!this.bookProform.valid) {
      ...
      console.log("dddd", this.serviceAddressForm.value)
      ...
      DirectBookingleadDetailsObj['password'] = this.serviceAddressForm.value.password
